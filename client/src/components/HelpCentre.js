...
const HelpCenter = () => {
    return ( 
        <div className="grid grid-cols-1  ">
            ...
            <div className="flex rounded-full bg-gray-100 border-gray-100 m-2 items-center p-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6">
                    <path fillRule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clipRule="evenodd" />
                </svg>
                <input type="search" className="text-xs w-full border-none bg-gray-100" />
            </div>
            
            <div className="grid grid-cols-2 m-3 gap-2 mb-2">
                <Link to={`/compliant`} className="flex flex-col gap-y-2 shadow-md rounded-md p-2 justify-center items-center text-center">
                    ...
                    <h4 className="text-xs">Account Settings</h4>
                </Link>
                <Link to={`/passwordrecovery`} className="flex flex-col gap-y-2 shadow-md rounded-md p-2 items-center text-center justify-center">
                    ...
                    <h4 className="text-xs">Login and password</h4>
                </Link>
                <Link to={`/passwordrecovery`} className="flex flex-col gap-y-2 shadow-md rounded-md p-2 justify-center items-center text-center">
                    ...
                    <h4 className="text-xs">Privacy and security</h4>
                </Link>
                <Link to={`/compliant`} className="flex flex-col gap-y-2 shadow-md rounded-md p-2 items-center text-center justify-center">
                    ...
                    <h4 className="text-xs">Marketplace</h4>
                </Link>
                <Link to={`/compliant`} className="flex flex-col gap-y-2 shadow-md rounded-md p-2 justify-center items-center text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" data-name="1" viewBox="0 0 128 128" className="w-12 h-12">
                    ...
                    <h4 className="text-xs">Groups</h4>
                </Link>
                <Link to={`/compliant`} className="flex flex-col gap-y-2 shadow-md rounded-md p-2 justify-center items-center text-center">
            ...
            <h4 className="mx-3 mt-5 font-semibold ">Looking for something else?</h4>
