    ...
    return ( 
        <div className="grid grid-cols-1  ">
            ...
            <div className="grid grid-cols-2 m-3 gap-2 mb-2">
                <Link to={`/compliant`} className="flex flex-col shadow-md rounded-md p-2 justify-center items-center text-center">
                ...
                <Link to={`/compliant`} className="flex flex-col shadow-md rounded-md p-2 items-center text-center justify-center">
