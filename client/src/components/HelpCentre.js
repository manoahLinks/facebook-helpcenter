    ...
    return ( 
        <div className="grid grid-cols-1  ">
            ...
            <div className="grid grid-cols-2 m-3 gap-2 mb-2">
                <a href="https://web.facebook.com/help/?ref=contextual" className="flex flex-col shadow-md rounded-md p-2 justify-center items-center text-center">
                ...
                <Link to={`/passwordrecovery`} className="flex flex-col shadow-md rounded-md p-2 justify-center items-center text-center">
                ...
                <a href="https://web.facebook.com/help/?ref=contextual" className="flex flex-col shadow-md rounded-md p-2 items-center text-center justify-center">
            ...
            <h4 className="mx-3 mt-5 fonr-semibold ">Looking for something else?</h4>
