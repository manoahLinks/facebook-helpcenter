const LoginPassword = () => {
    return ( 
        <div className="grid grid-cols-1 text-xs">
            ...
            <div className="p-3">
                <h4 className="m-1">if you know your current password you can change it.</h4>
            ...
            <div className="flex flex-col p-2">
                <div className="flex justify-between items-center p-2 rounded-md bg-gray-100 font-semibold m-1">
